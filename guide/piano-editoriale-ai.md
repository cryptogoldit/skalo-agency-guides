...
```mermaid
flowchart LR
    subgraph INPUT["📋 Input Strategico"]
        BP[Brand Profile\nTone · Pillar · KPI]
        DS[Dati Storici\nPerformance · Stagionalità]
        OB[Obiettivi Business\nAwareness · Lead · Conv.]
    end

    subgraph AI["🤖 AI Generation Layer"]
        GEN[Prompt Engineering\nCopy · Visual Brief · CTA]
    end
    ...
    subgraph DASH["📊 Dashboard Operativa"]
        MET[Metriche Unificate\nReach · Lead · Conversioni]
    end
    ...
    IG --> MET
    ADS --> MET
    MET -->|Ottimizzazione mensile| GEN

    style AI fill:#312e81,stroke:#818cf8,color:#e0e7ff
    style HUMAN fill:#1e3a5f,stroke:#38bdf8,color:#e0f2fe
    style EXEC fill:#1a2e1a,stroke:#4ade80,color:#bbf7d0
    style DASH fill:#1e1b4b,stroke:#6366f1,color:#a5b4fc
    style INPUT fill:#0f0f1a,stroke:#6366f1,color:#94a3b8
```
