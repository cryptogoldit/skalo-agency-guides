...
```mermaid
flowchart TD
    A["🔍 01 AUDIT\nTracciamento · Pipeline · Sito"] --> B["📡 02 TRACKING\nGTM · Meta Pixel · CAPI · GA4"]
    B --> C["📢 03 CAMPAGNE\nGoogle Ads · Meta Ads · LinkedIn"]
    C --> D["🤖 04 LEAD ENGINE\nScraping · AI Scoring · Enrichment\n(Automated Lead Gen Engine)"]
    D --> E["🗂️ SKALO CRM\nPipeline · Script Vendita · Offerte AI\n(Sales Operating System)"]
    E --> F["⚙️ OTTIMIZZAZIONE SETTIMANALE\nROAS · CPL · CAC · A/B Test"]
    F --> G["📊 REPORT OPERATIVO\nSpesa · Conversioni · Azioni"]
    G -->|"Loop di ottimizzazione continua"| C
    ...
    style D fill:#1e1b4b,stroke:#818cf8,color:#c7d2fe
    style E fill:#1e1b4b,stroke:#818cf8,color:#c7d2fe
    style F fill:#1e1b4b,stroke:#6366f1,color:#c7d2fe
    style G fill:#1e1b4b,stroke:#6366f1,color:#c7d2fe
```
